          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                  {provider.display_name ?? `${provider.namespace}/${provider.name}`}
                </h1>
                {provider.display_name && (
                  <p className="text-xs text-gray-400 dark:text-gray-500 font-mono mt-0.5">
                    registry: {provider.namespace}/{provider.name}
                  </p>
                )}
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-semibold text-gray-900 dark:text-white">
                  Configure Terraform / OpenTofu CLI
                </h3>
              </div>
              
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                Create or edit <code className="px-2 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">~/.terraformrc</code> or <code className="px-2 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">~/.tofurc</code> (Linux/macOS) 
                or <code className="px-2 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">%APPDATA%\terraform.rc</code> / <code className="px-2 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs font-mono">%APPDATA%\tofu.rc</code> (Windows):
              </p>
  ...
  token = "your-api-key-here"
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-base font-semibold text-gray-900 dark:text-white">
                  Configure Provider in Terraform / OpenTofu
                </h3>
              </div>
          ...
          <dl className="space-y-3">
            ...
            {provider.display_name && (
              <div>
                ...
                <dd className="text-sm font-medium text-gray-900 dark:text-white">{provider.display_name}</dd>
              </div>
            )}
            <div>
              <dt className="text-sm text-gray-500 dark:text-gray-400">Registry Name</dt>
              <dd className="text-sm font-medium text-gray-900 dark:text-white font-mono">{provider.name}</dd>
            </div>
            {provider.source_url && (
              <div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          ...
          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <p className="text-xs text-gray-500 dark:text-gray-400">
              ...
              Only enabled versions with uploaded binaries are visible to Terraform and OpenTofu.
            </p>
          </div>
        </div>
      </div>
